...
func TestMarshalCsnTlv(t *testing.T) {
	var tests = []struct {
		desc string
		m    *CsnTlv
		b    []byte
	...
	}{
		{
			desc: "Correct TLV values",
			m: &CsnTlv{
				UpstreamTxTime:    UScaledNs{1, 2},
				NeighborRateRatio: 2,
				NeighborPropDelay: UScaledNs{3, 4},
				DelayAsymmetry:    UScaledNs{5, 6},
			},
			b: append([]byte{0x0, 0x3, 0x0, 0x2e,
				0x0, 0x80, 0xc2, 0x0, 0x0, 0x3,
				// upstreamTxTime
				0x0, 0x0, 0x0, 0x1,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2,
				// neighborRateRatio
...
func TestUnmarshalCsnTlv(t *testing.T) {
	var tests = []struct {
		desc string
		m    *CsnTlv
		b    []byte
		...
		{
			desc: "Invalid TLV type",
			b: append([]byte{0x0, 0x2, 0x0, 0x2e,
				0x0, 0x80, 0xc2, 0x0, 0x0, 0x3,
				// upstreamTxTime
				0x0, 0x0, 0x0, 0x1,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2,
		...
		{
			desc: "Mismatch lengthField and actual amount of bytes",
			b: append([]byte{0x0, 0x3, 0x0, 0x2b,
				0x0, 0x80, 0xc2, 0x0, 0x0, 0x3,
				// upstreamTxTime
				0x0, 0x0, 0x0, 0x1,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2,
